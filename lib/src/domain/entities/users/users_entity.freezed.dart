...
class __$$_UserEntityCopyWithImpl<$Res>
    extends _$UsersEntityCopyWithImpl<$Res, _$_UserEntity>
...
class _$_UserEntity implements _UserEntity {
  _$_UserEntity({required final List<UserEntity> users}) : _users = users;
  ...
  @override
  String toString() {
    return 'UsersEntity(users: $users)';
  }
...
abstract class _UserEntity implements UsersEntity {
  factory _UserEntity({required final List<UserEntity> users}) = _$_UserEntity;
